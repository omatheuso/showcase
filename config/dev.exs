...
config :showcase, ShowcaseWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "jVr33MZADMWCXbT7pmHviddCPJYUREpVjXwIDbITcTTgoi9Fn4IHfv8GZD7H4DnQ",
  watchers: [
...
config :showcase, ShowcaseWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/showcase_web/router\.ex$"E,
      ~r"lib/showcase_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
